...
class Fusion(object):
    ...
    def __init__(self, pitch=0, heading=0, roll=0):
    ...
    def update_nomag(self, deltat, accel, gyro):  # 3-tuples (x, y, z) for accel, gyro
        ax, ay, az = accel  # Units G (but later normalised)
        gx, gy, gz = (radians(x) for x in gyro)  # Units deg/s
        # if self.start_time is None:
        #    self.start_time = input_time  # First run
        ...
        # deltat = input_time - self.start_time
    ...
    def update(self, input_time, accel, gyro, mag):  # 3-tuples (x, y, z) for accel, gyro and mag data
